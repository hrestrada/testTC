...
if (window.needleParam.events = 'purchase'){console.log("API 3");
      var params={visitorId:varVisitorID,currencyCode:window.needleParam.currencyCode,orderId:window.needleParam.orderId,orderItems:window.needleParam.orderItems},
      options={method:"POST",body:JSON.stringify(params)};
      fetch(siteUrl+"/services/apexrest/Purchase/" + varProjectID,options),console.log("API 4")}}                                                               
